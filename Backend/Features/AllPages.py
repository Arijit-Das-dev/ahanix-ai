...
Jarvis_DocMind_page = st.Page("DocMind.py", title="DocMind", icon=":material/search:")
pages = [account_page,home_page, main_page, code_page, image_page, prompt_eng_page, Jarvis_DocMind_page]
